...
const GOVERNOR = require("./deployments/areon/GovernorContract.json")
const STATION_REGISTRY = require("./deployments/areon/StationRegistry.json")
const VEHICLE_LEDGER = require("./deployments/areon/VehicleLedger.json")
const ELECTRA_TOKEN = require("./deployments/areon/ElectraToken.json")

const app = express()
const port = 3002

// Initialize your Ethereum provider (e.g., Infura)
const provider = new ethers.providers.JsonRpcProvider("https://areon.zone:8545")
let chainId = 417834
